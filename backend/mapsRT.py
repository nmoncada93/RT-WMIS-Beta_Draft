...
# Registrar el Blueprint con el nuevo prefijo
## app.register_blueprint(mapsRT_blueprint, url_prefix='/mapsRT')
    ...
    try:
        ...
        with open(file_path, 'r') as file:
            for line in file:
                ...
                # [B.1] Detectar encabezados de tiempo ------------------------
        ...
        # [B.4] Maneja errores durante el procesamiento ---------------------
        return {"Problema procesando los datos..."}

# [C] Endpoint para servir el archivo JSON -----------------------------------
@mapsRT_blueprint.route('/get-json', methods=['GET'])
def get_json():
    ...
    # [C.4] Define ruta base relativa al archivo actual -----------------
    base_dir = os.path.dirname(os.path.abspath(__file__))
    file_path = os.path.join(base_dir, "upc_tmp", file_name)

    # [C.6] Convierte archivo a JSON -------------------------------------
...
# [D] Funcion para procesar igp_roti.dat -----------------------------------
def convert_roti_to_json(file_path):
    ...
    try:
        ...
        # Lee archivo línea por línea para procesar encabezados y datos
        with open(file_path, 'r') as file:
            for line in file:
                line = line.strip()  # Elimina espacios al inicio y al final
            ...
            # [D.3] Añade el último bloque al JSON -------------------
            if current_time is not None and data_block:
                json_output.append({
                    "TIME": current_time,
                    "data": data_block
        ...
        # [D.4] Maneja errores durante el procesamiento -----------------
        return {"error": str(e)}


    # [E] Endpoint para servir datos de igp_roti.dat ----------------------------
@mapsRT_blueprint.route('/get-roti-json', methods=['GET'])
def get_roti_json():
