...
@indexPR_blueprint.route('/descomprimir-archivos/<int:year>/<int:doy>', methods=['POST'])
...
@indexPR_blueprint.route('/api/read-sphi/<int:year>/<int:doy>', methods=['GET'])
...
@indexPR_blueprint.route('/api/read-roti/<int:year>/<int:doy>', methods=['GET'])
